...
public class Solution05 {
    ...
    public int[] solution(int N, int[] votes) {
        ...
        for (int i = 1, idx = 0; i <= N; i++) {
            if (voteCounter[i] == maxVal) {
                // answer[idx] = voteCounter[i]; // 해당 부분이 잘못된 부분으로 아래 코드와 같이 수정하면 원하는 결과 값을 리턴할 수 있음.
                answer[idx] = i;
                idx += 1;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Solution: return value of the method is " + Arrays.toString(ret1) + " ."); // [5]
        ...
        // Press Run button to receive output.
        System.out.println("Solution: return value of the method is " + Arrays.toString(ret2) + " ."); // [2, 3]
    }
