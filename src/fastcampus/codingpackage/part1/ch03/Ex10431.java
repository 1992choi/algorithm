...
/*
    또 다른 풀이방법.
    - 실제 정렬하지 않고, 자기보다 앞에 큰 수를 카운트하면 된다.

    [2] 5 7 8 1 9 : 첫 학생은 제일 앞에 위치.
    2 [5] 7 8 1 9 : 앞에 큰 사람이 없으니 0으로 카운트.
    2 5 [7] 8 1 9 : 앞에 큰 사람이 없으니 0으로 카운트.
    2 5 7 [8] 1 9 : 앞에 큰 사람이 없으니 0으로 카운트.
    2 5 7 8 [1] 9 : 앞에 큰 사람이 4명 존재. 4로 카운트
      - 실제 1을 위치시키면 [1] 2 5 7 8 9 가 되므로, 정렬하는 것과 단순 카운트하는 것과 동일한 결과를 얻을 수 있다.
 */